  ...
  this.handleClick = function(e) {
    ...
    if (!o) {
      ...
      return true;
		...
		//permalink = 'http://soundcloud.com' +o.getAttribute('href');
		//	
		//$.get(
		//  'http://api.soundcloud.com/resolve.json?url=' +permalink+ '&client_id=' +client_id, 
		//  function (track) {
		//    o.setAttribute('href', track.stream_url+ '?consumer_key=212b7a5080f5d7f8e831583446771a02');
		playTrack();
		//  }
		//);
	        ...
	        if (thisSound === self.lastSound) {
	          ...
	          if (thisSound.readyState !== 2) {
	            if (thisSound.playState !== 1) {
	              // not yet playing
	              thisSound.play();
								$('html, body').animate({scrollTop: $('#' +sID).offset().top -50 }, 'fast');
	            } else {
...
//		var character = String.fromCharCode(keyInfo.code);
//		if (character == 'N' || character == 'J' || character == 'B') {
//			nextTrack();
//			return false;
//		} else if (character == 'P' || character == 'K' || character == 'Z') {
//			prevTrack();
//			return false;
//		} else if (character == 'L' || character == 'H' || character == 'F') {
//			toggleFavoriteItem();
//			return false;
//		} else if (character == 'X' || character == 'C' || character == 'Z' || keyInfo.code == 32) {
//			togglePlay();
//			return false;
//		} else if (character == 'V') {
//			stopTrack();
//			return false;
//		} else if (keyInfo.code == 189) {
//			if (player_volume > 4) {
