      ...
      this.emit('onLoad', this.evaluate(function() { //!
        ...
        var trackSet = [];
			  for (var i = 0; i < listLen; i++) {
			    ...
			    trackSet[i].albumArtURI = (function() {if (list.item(i).querySelector('div.inner div.tmb img')) {  return list.item(i).querySelector('div.inner div.tmb img').getAttribute('src');} else {  return '/img/placeholder.png'}})(); //handling tracks where there isn't album art
